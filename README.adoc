...
=== Xerces-J
Note that Apache Xerces-J https://xerces.apache.org/xerces2-j/dom.html[implements DOM Level 1 HTML] (https://lists.apache.org/list?j-users@xerces.apache.org:2012-5:html[related discussion]).
Thus, I suppose that it should support https://www.w3.org/TR/DOM-Level-1/level-one-core.html[bootstrapping].
