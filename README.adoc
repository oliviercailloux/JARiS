...
I will make reasonable efforts to answer timely and fix bugs (or at least document them).
...
== Compiler bug
Bug about https://github.com/oliviercailloux/JARiS/compare/simplified...solved[inference] https://bugs.openjdk.org/browse/JDK-8325085[reported] on the 17th of Jan 2024.
...
Please give a thumbs up on that issue if this seems of interest.
