...
== Catalog stuff
Complex example: https://stackoverflow.com/questions/8412798/how-to-load-xmlcatalog-from-classpath-resources-inside-a-jar-reliably
Obtain CatalogResolver: https://docs.oracle.com/en/java/javase/22/docs/api/java.xml/javax/xml/catalog/class-use/CatalogResolver.html
Then use it as URIResolver: https://docs.oracle.com/en/java/javase/22/docs/api/java.xml/javax/xml/transform/class-use/URIResolver.html
