...
== TODO
Saxon does not stop when listener warning throws.
Saxon messaging does not reach listener, contrary to Xalan. Propose property to do so. Permits to stop processing, also, and get rid of the saxon specific message consumer (handler). https://saxonica.plan.io/boards/3/topics/9906 https://saxonica.plan.io/issues/6685