 ...
 * </p>
 * <p>
 * Stores two pieces of login information as String: username and password. Each of these values can
...
public class Credentials {
  ...
  /**
   *
   * @return The value of the username which can be an empty String but never <code>null</code>.
   */
  ...
  /**
   *
   * @return The value of the password which can be an empty String but never <code>null</code>.
   */
