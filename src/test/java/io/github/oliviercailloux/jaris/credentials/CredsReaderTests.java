...
class CredsReaderTests {
  ...
  public void testPropAndEnvReadCredentials() throws Exception {
    CredsReader credsReader =
        CredsReader.given(DEFAULT_USERNAME_KEY, DEFAULT_PASSWORD_KEY, getNonExistentFile());
    credsReader.env =
        Map.of(DEFAULT_USERNAME_KEY, "env username", DEFAULT_PASSWORD_KEY, "env password");
  ...
  public void testEmptyFile() throws Exception {
    {
      CredsReader credsReader =
          CredsReader.given(DEFAULT_USERNAME_KEY, DEFAULT_PASSWORD_KEY, createApiLoginFile());
      credsReader.env = Map.of();
  ...
  public void testIncorrectFileReadCredentials() throws Exception {
    ...
    final Exception exception =
        assertThrows(IllegalStateException.class, () -> credsReader.readCredentials());
